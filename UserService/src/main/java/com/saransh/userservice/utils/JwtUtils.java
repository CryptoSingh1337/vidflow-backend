package com.saransh.userservice.utils;
...
import com.saransh.userservice.model.response.RefreshTokenResponseModel;
...
public class JwtUtils {
    ...
    public JwtUtils(Environment env, ObjectMapper objectMapper) {
        this.env = env;
